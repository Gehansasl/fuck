...
const store = makeInMemoryStore({ logger: pino().child({ level: 'silent', stream: 'store' }) })	
    ...
    conn.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            console.log('CHALAH-MD connected ✅')
await conn.sendMessage(config.OWNER_NUMBER + "@s.whatsapp.net", {
text: "*📍 S E N U - M D successfully connected* ✓\n\n\n> ◦ *Official GitHub* - ```https://github.com/```\n> ◦ ᴊᴏɪɴ ᴏᴜʀ sᴜᴘᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ ᴠɪᴀ ᴛʏᴘᴇ: https://whatsapp.com/channel/0029Vb2OcviBFLgPzVjWhE0n*📍 SENU MD ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴄʀᴇᴀᴛᴇᴅ ʙʏ • ᴊᴇꜱᴛᴇʀ ᴛᴇᴄʜ*",
contextInfo: {
externalAdReply: {
title: "👨‍💻 S E N U - M D 👨‍💻\nSuccessfully Connected !",	
thumbnailUrl: 'https://i.ibb.co/bjPrbF84/3174.jpg',
sourceUrl: "",
mediaType: 1,
...
q = args.join(' ')		
      ...
      console.log(command)
	    ...
	    const ownbot = '94788770020'
	    const isownbot = ownbot?.includes(senderNumber)
            const vajira = '94775877546'
            const isVajira = Jester?.includes(senderNumber)
	    const developers = '94783613116'
            const isbot = botNumber.includes(senderNumber)
	    const isdev = developers.includes(senderNumber) 	    
            let epaneda ='94721291447'
...
app.get("/", (req, res) => {
res.send("📟 SENU MD  Working successfully!");
});
