...
const userName = 'CHALAH73';
const token = process.env.GIT_TOKEN
const repoName = 'CHALAH-MD-V1';
...
PREFIX: '',
FOOTER: '©CHALAH MD',
LOGO: `https://i.ibb.co/SDsDFvWW/9068.jpg` 
}
...
config.PREFIX = ''
config.FOOTER = '©CHALAH  - MD '
config.LOGO = `https://i.ibb.co/SDsDFvWW/9068.jpg` 
config.ANTI_BAD = []
