...
*🌟 𝗝𝗼𝗶𝗻 𝗨𝘀 -*https://whatsapp.com/channel/0029Vb2OcviBFLgPzVjWhE0n*
...
> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱᴇɴᴜ-ᴍᴅ*`;
        ...
        // Send video details
        await conn.sendMessage(from, { image: { url: data.result.thumbnail || '' }, caption: ytmsg, contextInfo }, { quoted: mek });
...
> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ꜱᴇɴᴜ-ᴍᴅ *`;
        ...
        // Send song details
        await conn.sendMessage(from, { image: { url: data.result.image || '' }, caption: ytmsg, contextInfo }, { quoted: mek });
